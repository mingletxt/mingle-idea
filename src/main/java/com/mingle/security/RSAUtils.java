...
/**
 * Created by mingle. Time 2019-07-05 16:15 Desc 文件描述
 */
public class RSAUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String encodeStr = new String(Base64Utils.encode(encodedData));
        System.out.println(encodeStr);
        System.out.println(new String(RSAUtils.decryptByPublicKey(Base64Utils.decode(encodeStr.getBytes()), publicKey)));
        
        byte[] decodedData = RSAUtils
                .decryptByPrivateKey(Base64Utils.decode("mIENuMEvbTkceKAzoqDLx8qiuZ12wZ5eRhZMKf2dfL+ZJkxJHnBXxNZiMpbIFHjIJSoP7sBxknR8PEPFAVgNoL2HqlEmOGFzpXugWK37fDpoKSOFpT0AKJyY4/j87F52YZlIjsJgk74+KDyrPKxagzEZejb8bAI4Ln/54UaVhd0=".getBytes()),
                        privateKey);
