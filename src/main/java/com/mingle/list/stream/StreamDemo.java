package com.mingle.list.stream;
...
/**
 * Created by mingle.
 * Time 17/1/23 下午10:16
 * Desc Kangjun Ways of Creating a Stream in Java 8
 */
public class StreamDemo {
    ...
    public static void collectionStream() {
        ...
        Stream<String> stream = list.parallelStream().filter(a -> a.length() > 3);
