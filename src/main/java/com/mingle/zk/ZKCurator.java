...
/**
 * Created by mingle. Time 2019-06-18 14:11 Desc 文件描述
 */
    ...
    private static void registerWatcher(CuratorFramework zkClient) throws Exception {
        ...
        watcher.getListenable().addListener(new PathChildrenCacheListener() {
            public void childEvent(CuratorFramework curatorFramework, PathChildrenCacheEvent pathChildrenCacheEvent) throws Exception {
                System.out.println("event:" + pathChildrenCacheEvent);
            }
        });
    ...
    public static void registTreeCache(CuratorFramework client) throws Exception {
        ...
        treeCache.getListenable().addListener(new TreeCacheListener() {
            public void childEvent(CuratorFramework curatorFramework, TreeCacheEvent treeCacheEvent) throws Exception {
                System.out.println("treeCacheEvent: " + treeCacheEvent + " data: " + new String(treeCacheEvent.getData().getData()));
            }
        });
        //没有开启模式作为入参的方法
        treeCache.start();
